...
def plot_runtimes(folder_name):
    ...
    elif ("permutation" in df['Experiment'].values):    
    ...
    # Customize the plot
    plt.title('Runtime of Each Experiment')
    ...
    plt.savefig(os.path.join(folder_name, "runtime_plot.png"), bbox_inches='tight')
    plt.savefig(os.path.join(folder_name, "runtime_plot.pdf"), bbox_inches='tight')
    plt.show()
